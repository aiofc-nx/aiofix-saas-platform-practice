/**
 * @class OrganizationDeactivatedEvent
 * @description 组织停用事件
 *
 * 原理与机制：
 * 1. 继承DomainEvent基类
...
export class OrganizationDeactivatedEvent extends DomainEvent {
  public readonly eventType = 'OrganizationDeactivated';
   ...
   * @returns 事件数据
   */
  public getEventData(): OrganizationDeactivatedEventData {
    return {
