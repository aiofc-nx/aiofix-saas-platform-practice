 ...
 * @description IAM 密码加密服务
 *
 * 该文件实现了IAM领域的密码加密服务，包括：
 * - 密码哈希
 * - 密码验证
 * - 密码复杂度验证
 * - 密码生成
...
import type { PasswordConfig } from '../config/security.config';
 ...
 */
@Injectable()
export class IamPasswordService {
